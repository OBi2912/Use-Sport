            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-section">
                        <div className="logo" style={{ marginBottom: '1rem', fontSize: '2rem' }}>Use<span>Sport</span></div>
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-links">
                            ...
                            <li><Link to="/checkout">{t('cart')}</Link></li>
                            <li><a href="#categories">{t('about')}</a></li>
                        </ul>
                    </div>

                    {/* Sports Categories */}
                    <div className="footer-section">
                        <h3 className="footer-title">{t('shopBySport')}</h3>
                        <ul className="footer-links">
                            <li><a href="#soccer">{t('soccer')}</a></li>
                            <li><a href="#basketball">{t('basketball')}</a></li>
                            <li><a href="#swimming">{t('swimming')}</a></li>
                ...
                <div className="footer-bottom">
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                        &copy; 2027 Use Sport. {t('footerRights')}
                    </p>
                </div>
            </div>
        </footer>
